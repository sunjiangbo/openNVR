...
private:
#ifdef TRISOS
  friend class H264VideoStreamServerMediaSubsession;
  friend class SimpleAudioStreamServerMediaSubsession;
  friend class MPEG4VideoStreamServerMediaSubsession;
  friend class MP2PVideoStreamServerMediaSubsession;
#endif
