...
static int mp2p_g711_audio_parse(Track *tr, uint8_t *data, size_t len, 
                                   uint8_t *buf, size_t bufSize, size_t maxSize)
{
    unsigned i;
    int64_t pts, dts;
...
static const mp2p_stream_struct mp2p_streams[] = {
    ...
    { CODEC_ID_PCM_MULAW, "PCMU", 0x90, mp2p_g711_audio_parse, noKeyFrame},
    { CODEC_ID_PCM_ALAW, "PCMA", 0x90, mp2p_g711_audio_parse, noKeyFrame},
